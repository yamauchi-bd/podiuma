...
// ユーザーの投稿を取得
$sql = "SELECT * FROM post_table WHERE userId=:userId AND userId=:userId LIMIT 3";
$stmt = $pdo->prepare($sql);
...
<div class="bg-white w-full h-screen py-6 sm:py-8 lg:py-12 bg-opacity-90">
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <div class="mb-10 md:mb-16">
      <h2 class="mb-2 text-center text-xl font-bold text-gray-800 md:mb-1 lg:text-2xl"><?php echo $_SESSION["username"]; ?> さんの</h2><h2 class="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">おすすめグルメ BEST3</h2>
    </div>
    <!-- text - end -->
