            ...
            <div class="mx-auto max-w-screen-2xl max-h-1.5 px-4 md:px-8">
                ...
                <form method="post" action="userRegisterExec.php" enctype="multipart/form-data" class="bg-white mx-auto max-w-lg rounded-lg border">
                    ...
                    <div class="flex items-center justify-center bg-gray-100 p-4 rounded-b-lg">
                        <p class="text-center text-sm text-gray-500">アカウントをすでに持っている方は<a href="login.php" class="text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700">ログイン</a>してください。</p>
                    </div>
                </form>
            </div>
        </div>
